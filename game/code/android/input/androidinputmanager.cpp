...
void AndroidInputManager::TouchDown( int ID, int xTouch, int yTouch )
{
	TouchData data;
    data.mID = ID;
...
void AndroidInputManager::TouchUp( int ID, int xTouch, int yTouch )
{
	TouchData data;
    data.mID = ID;
...
void AndroidInputManager::TouchMove( int ID, int xTouch, int yTouch )
{    
	TouchData data;
    data.mID = ID;
...
void AndroidInputManager::TouchZoom( float zTouch )
{	
...
void AndroidInputManager::Accelerometer()
{	
	//if ( GetKey( VK_LEFT ) )
	//{
