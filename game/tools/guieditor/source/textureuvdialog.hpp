...
public:
	...
	void OnButtonClickCopySize( wxCommandEvent& event );
    void OnButtonClickCopyPosition( wxCommandEvent& event );
    void OnButtonClickPasteSize( wxCommandEvent& event );
    void OnButtonClickPastePosition( wxCommandEvent& event );
