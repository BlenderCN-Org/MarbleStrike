...
class TextureUVDialogGui : public wxDialog 
{
	...
	protected:
		...
		virtual void OnButtonClickCopySize( wxCommandEvent& event ) { event.Skip(); }
		virtual void OnButtonClickCopyPosition( wxCommandEvent& event ) { event.Skip(); }
		virtual void OnButtonClickPasteSize( wxCommandEvent& event ) { event.Skip(); }
		virtual void OnButtonClickPastePosition( wxCommandEvent& event ) { event.Skip(); }
	...
	public:
		...
		TextureUVDialogGui( wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& title = wxEmptyString, const wxPoint& pos = wxPoint( 30,30 ), const wxSize& size = wxSize( 936,725 ), long style = wxDEFAULT_DIALOG_STYLE );
		~TextureUVDialogGui();
